...
/*Change Sent Data */
var Data = { FrontDistance: 0, BackDistance: 0 }
        ...
        btSerial.connect(
          ...
          function () {
            ...
            btSerial.on('data', function (bufferData) {
              ...
              Data = Buffer.from(bufferData).toString()
              ...
              // We also add an escape character '/n' to the end of the string
...
setTimeout(() => {
  Data = { FrontDistance: 10, BackDistance: 10, notLoaded: true }
}, 10000)

app.use(express.static('website/website'))

const Server = new WebSocket.Server({ server: app, path: '/data' })
